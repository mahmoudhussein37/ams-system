...
public interface UploadedFileMapper {
        ...
        List<UploadedFile> findByDesignationYear(@Param("designation") Designation designation,
                        @Param("year") int year);

        @Select("SELECT * FROM `uploaded_file` where designation = #{designation} and prof_course_id = #{profCourseId}")
        List<UploadedFile> findByDesignationProfCourseId(@Param("designation") Designation designation,
