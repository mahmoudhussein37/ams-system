        ...
        <div class="login-content flex-row-fluid d-flex flex-column justify-content-center position-relative overflow-hidden p-7 mx-auto">
            ...
            <div class="d-flex flex-column-fluid flex-center">
                ...
                <div class="login-form login-signup">
                    <!--begin::Form-->
                    <form:form id="signup-form" action="${baseUrl}/feedback" commandName="feedback" method="post">
                        <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}"/>
                        <!--begin::Title-->
                        <div class="pb-13 pt-lg-0 pt-5">
                            <h3 class="font-weight-bolder text-dark font-size-h4 font-size-h1-lg"><spring:message code="common.errorReport"/></h3>
                        ...
                        <div class="form-group">
                            ...
                            <form:input class="form-control form-control-solid h-auto rounded" type="text" placeholder="${labelNumber}" path="number" required="true" autocomplete="off"/>
                        </div>
                        <div class="form-group">
                            <c:set var="labelName">
                                <spring:message code="common.name"/>
                            </c:set>
                            <form:input class="form-control form-control-solid h-auto rounded" type="text" placeholder="${labelName}" path="name" required="true" autocomplete="off"/>
                        </div>
                        <div class="form-group">
                            <c:set var="labelEmail">
                                <spring:message code="common.email"/>
                            </c:set>
                            <form:input class="form-control form-control-solid h-auto rounded" type="text" placeholder="${labelEmail}" path="email" required="true" autocomplete="off"/>
                        </div>
                        <!--begin::Form group-->
                        <div class="form-group">
                            <c:set var="labelError">
                                <spring:message code="admin.errorDetail"/>
                            </c:set>
                            <form:textarea path="contents" rows="6" required="true"  placeholder="${labelError}" class="form-control"/>
                        ...
                        <div class="form-group d-flex flex-wrap pb-lg-0 pb-3">
                            <button type="submit" id="kt_login_signup_submit" class="btn btn-primary font-weight-bolder font-size-h6 px-8 py-4 my-3 mr-4"><spring:message code="common.submit"/></button>
