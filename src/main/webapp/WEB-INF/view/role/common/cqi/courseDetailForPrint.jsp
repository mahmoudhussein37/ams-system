...
<textarea rows="6" dir="${isRTL ? 'rtl' : 'ltr'}" class="form-control" disabled>
        ${prevCqi.plan}
                                                    ...
                                                    <td>
                                                        <form:textarea path="problem" rows="6"  dir="${isRTL ? 'rtl' : 'ltr'}" class="form-control" disabled="${menuAccess.cqi ? false : true}"/>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <form:textarea path="plan" rows="6" dir="${isRTL ? 'rtl' : 'ltr'}"  class="form-control" disabled="${menuAccess.cqi ? false : true}"/>
                                        </div>
                                    </div>
