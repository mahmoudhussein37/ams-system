            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="card card-custom">
                        ...
                        <div class="card-body">
                            <form:form modelAttribute="article" action="/admin/board/${boardName}/form" method="post">
                                <div class="row">
                                    <div class="col-md-12">

                                        <div class="form-group">
                                            <label><spring:message code="admin.board.schedule"/></label>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group">
                                            <label><spring:message code="admin.board.date"/></label>
                                            <form:input type="text" path="content" required="true" class="form-control"/>
                                        </div>
                                    </div>
