...
<script>
    ...
    <c:if test="${not empty firstUser}">
        $(".student-detail-div").load("${baseUrl}/admin/studentManagement/studentInformation/studentDetail?studentId=${firstUser.id}");
    </c:if>
    $("body").on('click', '.student-detail', function (e) {
        e.preventDefault();
        var studentId = $(this).attr("data-student-id");
        $(".student-detail-div").load("${baseUrl}/admin/studentManagement/studentInformation/studentDetail?studentId=" + studentId);
