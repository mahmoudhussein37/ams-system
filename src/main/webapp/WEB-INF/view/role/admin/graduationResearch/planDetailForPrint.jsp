                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" value="${stored.completeSemester}" disabled/>
                                                <%--<span class="form-text text-muted">Please enter your full name</span>--%>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <table class="table">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <textarea class="form-control" dir="${isRTL ? 'rtl' : 'ltr'}" rows="6" disabled>${stored.scope}</textarea>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <textarea class="form-control" dir="${isRTL ? 'rtl' : 'ltr'}" rows="6" disabled>${stored.ref}</textarea>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
