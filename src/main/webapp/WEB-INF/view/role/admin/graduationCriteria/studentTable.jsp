...
<script>
    ...
    <c:if test="${not empty firstUser}">
        $(".detail-div").load("${baseUrl}/admin/academicManagement/graduationCriteria/studentDetail?studentId=${firstUser.id}");
    </c:if>
    $("body").on('click', '.student-detail', function (e) {
        e.preventDefault();
        var studentId = $(this).attr("data-student-id");
        $(".detail-div").load("${baseUrl}/admin/academicManagement/graduationCriteria/studentDetail?studentId=" + studentId);
