<%@include file="/WEB-INF/view/include/topTag.jsp" %>
    ...
    <table class="table table-head-custom table-vertical-center" id="course-list">
        <thead>
            <tr class="text-uppercase">
                ...
                <th style=""><span class="text-primary">
                        <spring:message code="admin.maxStudent" />
                    </span>
                <th style=""><span class="text-primary">
                        <spring:message code="common.opening" />
                    </span>
                <th style=""><span class="text-primary">
                        <spring:message code="common.syllabus" />
                    </span>
            </tr>
        </thead>
        <tbody>
    ...
    <script>
        ...
        $("body").on('click', '.course-detail', function (e) {
            ...
            $(".detail-div").load("${baseUrl}/admin/courseManagement/syllabus/courseDetail?profCourseId=" + profCourseId);
