                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="card card-custom">
                                        <div class="card-header">
                                            <div class="card-header">
                                                <h3 class="card-title font-weight-bolder"><a class="btn btn-light"
                                                        href="${baseUrl}/professor/studentGuidance/counseling"><i
                                            ...
                                            <div class="row">
                                                <div class="col-md-2">
                                                    ...
                                                    <input type="text" id="search-number"
                                                        class="form-control input-enter" value=""
                                                ...
                                                <%--<div class="col-md-2">
                                                    ...
                                                    <select id="search-major" class="form-control"
                                                        style="margin-top:10px;">
                ...
                <div class="modal fade" id="ajax" role="basic" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <spring:message code="common.loading" />
                        </div>
                    </div>
                </div>
