...
<script>
    ...
    function searchCourse() {
        ...
        $(".course-table-div").load("/professor/classProgress/attendance/courseTable?year=" + year + "&semester=" + semester);
    }
    ...
    $(document).ready(function() {
        $(".course-table-div").load("/professor/classProgress/attendance/courseTable");
    });
