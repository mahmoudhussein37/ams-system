                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-custom">
                        <div class="card-header">
                            <h3 class="card-title font-weight-bolder"><spring:message code="menu.professor.sub2_4"/></h3>
                        </div>
                        <div class="card-body">
                                <div class="row">
...
<script>
    ...
    function searchCourse() {
        ...
        $(".course-table-div").load("/professor/classProgress/makeupClass/courseTable?year=" + year + "&semester=" + semester);
    }
    ...
    $(document).ready(function() {
        $(".course-table-div").load("/professor/classProgress/makeupClass/courseTable");
    });
