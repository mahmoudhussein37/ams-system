...
<script>
    ...
    <c:if test="${not empty firstCourse}">
        $(".course-detail-div").load("/professor/classProgress/inquiryCourse/courseDetail?courseId=${firstCourse.id}");
    </c:if>
    $("body").on('click', '.course-detail', function (e) {
        e.preventDefault();
        var courseId = $(this).attr("data-course-id");
        $(".course-detail-div").load("/professor/classProgress/inquiryCourse/courseDetail?courseId=" + courseId);
