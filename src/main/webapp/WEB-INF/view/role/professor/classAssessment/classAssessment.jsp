...
<script>
    ...
    function search() {
        ...
        $(".table-div").load("${baseUrl}/professor/classProgress/classAssessment/courseTable?year=" + year + "&semester=" + semester);
    }
    ...
    $(document).ready(function() {
        $(".table-div").load("${baseUrl}/professor/classProgress/classAssessment/courseTable");
    });
