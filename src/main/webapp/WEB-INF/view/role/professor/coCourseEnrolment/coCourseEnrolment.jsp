...
<script>
    ...
    function searchCourse() {
        ...
        $(".course-table-div").load("${baseUrl}/professor/studentGuidance/coCourseEnrolment/studentTable?year=" + year + "&semester=" + semester);
    }
    ...
    $(document).ready(function() {
        $(".course-table-div").load("${baseUrl}/professor/studentGuidance/coCourseEnrolment/studentTable");
    });
