<form:form class="form" modelAttribute="lectureContents" id="lectureContentsForm"
            ...
            <table class="table table-head-custom table-vertical-center" id="course-list">
                <thead>
                    <tr class="text-uppercase">
                        ...
                        <th class="text-center" style="width:5%"><span class="text-primary">
                                <spring:message code="common.week" />
                            </span></th>
                        <th class="text-center" style="width:60%"><span class="text-primary">
                                <spring:message code="common.classContents" />
                            </span>
                        <th class="text-center" style="width:35%"><span class="text-primary">
    ...
    <c:if test="${isEditable}">
        <div class="card-footer">
            <button type="submit" id="lecture-contents-save" class="btn btn-primary mr-2">
