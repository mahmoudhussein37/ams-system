                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-custom">
                        <div class="card-header">
                            <h3 class="card-title font-weight-bolder"><spring:message code="menu.professor.sub2_8"/></h3>
                        </div>
                        <div class="card-body">
                                <div class="row">
...
<script>
    ...
    function search() {
        ...
        $(".table-div").load("${baseUrl}/professor/classProgress/graduationResearchPlan/studentTable?year=" + year);
    }
